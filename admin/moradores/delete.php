...
<?php include '../../partes/topo_admin_moradores.php'; ?>
                ...
                <div class="col-md-10">
                    ...
                    <div class="row">
                        <div class="col-md-12">
				            <div class="well">
				              <h1 id="tables">Confirm delete <?php echo $name ?> [<?php echo $unidade ?>] ?</h1>
				            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-md-8 col-sm-offset-2">
            <form role="form" action="delete.php" method="post">
                ...
                <p class="alert alert-error">Are you sure you want to delete <?php echo $name ?> [<?php echo $unidade ?>] ?</p>
                <div class="well">
                	<button type="submit" class="btn btn-danger">Yes</button>
                	<a class="btn btn-default" href="lista.php">No</a>
            	</div>
        	</form>
    	</div>
	</div>
